...
if __name__ == '__main__':
    ...
    for estimators in range(start, end, step_size):
        for randomx in range(0, 20):
            clf = AdaBoostClassifier(base_estimator=None, n_estimators=estimators, learning_rate=2.5, algorithm='SAMME.R', random_state=None)
    ...
    plt.title('Iris AdaBoostClassifier')
    plt.grid(True)
    plt.show()
